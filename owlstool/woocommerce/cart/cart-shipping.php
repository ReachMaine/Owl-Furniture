 ...
 * @version     2.3.0
 */
/* 12Feb16 - change message for continue to checkout */
	...
	<td>
		...
		<?php elseif ( ( WC()->countries->get_states( WC()->customer->get_shipping_country() ) && ! WC()->customer->get_shipping_state() ) || ! WC()->customer->get_shipping_postcode() ) : ?>
			...
			<?php elseif ( is_cart() ) : ?>
				...
				<p><?php _e( 'Please continue to the checkout and enter your full address to see shipping rates.', 'woocommerce' ); ?></p>
